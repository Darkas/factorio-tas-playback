...
commandqueue[27548] = {{"build", "small-electric-pole", {-58.5, 21.5}, defines.direction.north}}
commandqueue[27549] = {{"build", "burner-inserter", {-58.5, 22.5}, defines.direction.west}}
commandqueue[27550] = {{"build", "burner-inserter", {-58.5, 24.5}, defines.direction.west}}
commandqueue[27551] = {{"build", "wooden-chest", {-59.5, 24.5}, defines.direction.north}}
commandqueue[27552] = {{"build", "burner-inserter", {-59.5, 23.5}, defines.direction.south}}
commandqueue[27555] = {{"build", "electric-mining-drill", {-61.5, 24.5}, defines.direction.east}}
...
commandqueue[31657] = {{"put", {40, -26}, "coal", 1, defines.inventory.fuel}}
commandqueue[31659] = {{"build", "transport-belt", {37.5, -22.5}, defines.direction.south}}
commandqueue[31660] = {{"build", "burner-inserter", {38.5, -24.5}, defines.direction.west}}
commandqueue[31661] = {{"put", {38.5, -24.5}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31671] = {{"put", {40, -28}, "coal", 1, defines.inventory.fuel}}
commandqueue[31672] = {{"build", "small-electric-pole", {41.5, -28.5}, defines.direction.north}}
...
commandqueue[31688] = {{"put", {40, -30}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31700] = {{"put", {40, -32}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31716] = {{"put", {40, -34}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31728] = {{"put", {40, -36}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31740] = {{"put", {40, -38}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31755] = {{"put", {40, -40}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31769] = {{"put", {40, -42}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31783] = {{"put", {40, -44}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31797] = {{"put", {40, -46}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[31816] = {{"put", {40, -48}, "coal", 1, defines.inventory.fuel}}
commandqueue[31817] = {{"put", {40, -50}, "coal", 1, defines.inventory.fuel}}
...
commandqueue[33121] = {{"take", {-59.5, 24.5}, "coal", "all", defines.inventory.chest}}
...
commandqueue[33294] = {{"craft", "burner-inserter", 5}}
...
-- ----------------------------------------- --
commandqueue[33980] = {{"print", "End of programmed route at tick 33970."}}
commandqueue[33981] = {{"print", "Carried out 3367 actions in 0h:9m:26sec."}}
commandqueue[33982] = {{"print", "This corresponds to an average APM of 356.8207."}}
